...
public class TimZobel_FS93_Lernsituation_3_Wetterstation 
{
  public static void main(String[] args) 
  {
    ...
    //Temp = Math.max(z12, Math.max(z23, Math.max(z34, Math.max(z45, Math.max(z56, Math.max(z67, Math.max(z78, Math.max(z89, Math.max(z910, Math.max(z1011, Math.max(z1112, Math.max(z1213, Math.max(z1314, Math.max(z1415, Math.max(z1516, Math.max(z1617, Math.max(z1718, Math.max(z1819, Math.max(z1920, Math.max(z2021, Math.max(z2122, Math.max(z2223, Math.max(z2324, Math.max(z2425, Math.max(z2526, Math.max(z2627, Math.max(z2728, Math.max(z2829, Math.max(z2930, Math.max(z3031, Math.max(z3132, Math.max(z3233, Math.max(z3334, Math.max(z3435, Math.max(z3536, Math.max(z3637, Math.max(z3738, Math.max(z3839, Math.max(z3940, Math.max(z4041, Math.max(z4142, Math.max(z4243, Math.max(z4344, Math.max(z4445, Math.max(z4546, Math.max(z4647, Math.max(z4748, Math.max(z4849, z4950)))))))))))))))))))))))))))))))))))))))))))))))); 
